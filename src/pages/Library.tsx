    ...
    const fetchData = async () => {
      try {
        ...
        if (user) {
          ...
          const ids = new Set(
            bookmarksData
              .filter((b: any) => b.contentType === "book")
          ...
          >
            ...
            <div className="p-5 flex-grow flex flex-col">
              ...
              <Link to={`/book/${book._id}`} className="block group/title">
                ...
                <h2 className="text-lg font-bold text-stone-900 mb-1 line-clamp-1 group-hover/title:text-stone-600 transition-colors">
                  {book.title}
                </h2>
              ...
              <p className="text-stone-600 text-xs line-clamp-2 mb-6 flex-grow">
                {book.description}
              </p>
