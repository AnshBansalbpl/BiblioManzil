...
const BookDetail: React.FC = () => {
  ...
  if (!book) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center px-6">
        <h1 className="text-2xl font-bold text-stone-900 mb-4">Book not found</h1>
        <Link to="/ebooks" className="text-stone-600 hover:text-stone-900 flex items-center gap-2">
  ...
  return (
    <div className="pt-32 pb-20 px-6 max-w-6xl mx-auto">
      ...
      >
        <Link to="/ebooks" className="inline-flex items-center gap-2 text-stone-500 hover:text-stone-900 mb-12 transition-colors">
          <ArrowLeft className="w-4 h-4" /> Back to Library
        </Link>
          ...
          <div className="md:w-2/3">
            ...
            <div className="bg-stone-50 rounded-3xl p-8 mb-10">
              <h2 className="text-sm font-bold uppercase tracking-widest text-stone-400 mb-4 flex items-center gap-2">
                <Info className="w-4 h-4" /> About this book
              </h2>
